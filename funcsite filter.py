...
class EnvelopeScorer:
    ...
    def score(self, site: str, target_aa: str,
        ...
        # --- pose RMSD vs WT reference (frame-locked) ---
        rmsd = ligand_rmsd(self.ref.ligand_pose, mut_pose,
...
def run_pipeline(residue_features: pd.DataFrame,
    ...
    wt_ligand_pose_pdbqt: optional WT docked substrate pose PDBQT. If provided,
                       the first parsed pose is used as the reference pose. If
                       omitted, it is generated by docking ligand_pdbqt into the
                       WT receptor prepared from FoldX-repaired WT PDB, and the
                       lowest-score pose is used.
...
def _build_cli():
    ...
    p.add_argument("--wt-ligand-pose",
                   help="optional WT docked substrate pose PDBQT; first parsed "
                        "pose is used as reference. If omitted, it is generated "
                        "by docking --ligand into prepared WT")
